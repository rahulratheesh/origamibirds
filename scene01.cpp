...
//
//    PhysicsObject physicsObject1(new BoundingSphere(glm::vec3(glm::vec3(5.0, 0.0, 0.0),  1.0)), glm::vec3(-0.05f, 0.05f, 0.0f));
//    PhysicsObject physicsObject2(new BoundingSphere(glm::vec3(glm::vec3(-5.0, 0.0, 0.0), 1.0)), glm::vec3(0.05f, 0.05f, 0.0f));
//
...
//    cubeNode1->addComponent(cameraComponent);
...
//
//    Node* floorNode = new Node(glm::vec3(0.0, -1.0, 0.0), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(10.0f, 10.0f, 10.0f));
