...
void Scene02::init()
{
    ...
    PhysicsObject physicsObject1(glm::vec3(-3.0, -0.99, -5.0), glm::vec3(0.1f, -0.1f, 0.0f));
    PhysicsObject physicsObject2(glm::vec3(-5.0, -0.99, -5.0), glm::vec3(0.1f, -0.1f, 0.0f));
    PhysicsObject physicsObject3(glm::vec3(-7.0, -0.99, -5.0), glm::vec3(0.1f, -0.1f, 0.0f));
    ...
    Node* birdNode1 = new Node(glm::vec3(-3.0, -1.0, -5.0), glm::vec3(-90.0f, 0.0f, 0.0f), glm::vec3(0.25f, 0.25f, 0.25f));
    ...
    Node* birdNode2 = new Node(glm::vec3(-5.0, -1.0, -5.0), glm::vec3(-90.0f, 0.0f, 0.0f), glm::vec3(0.25f, 0.25f, 0.25f));
    ...
    Node* birdNode3 = new Node(glm::vec3(-7.0, -1.0, -5.0), glm::vec3(-90.0f, 0.0f, 0.0f), glm::vec3(0.25f, 0.25f, 0.25f));
